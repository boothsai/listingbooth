        ...
        <div style={{ background: 'white', padding: '48px', borderRadius: '24px', boxShadow: '0 24px 64px rgba(0,0,0,0.06)', width: '100%', maxWidth: '460px', border: '1px solid rgba(0,0,0,0.04)' }}>
          ...
          <div style={{ textAlign: 'center', marginBottom: '32px' }}>
            ...
            <p style={{ margin: 0, fontSize: '15px', color: '#666', lineHeight: 1.5 }}>
              Authenticate with your eXp Realty credentials to access the secure CRM environment.
            </p>
          </div>
          ...
          <button 
            ...
            style={{
              ...
              backgroundColor: '#111', color: 'white', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '12px',
              fontSize: '15px', fontWeight: 800, cursor: loading ? 'wait' : 'pointer',
              transition: 'all 0.2s', letterSpacing: '0.02em',
              boxShadow: '0 8px 24px rgba(0,0,0,0.12)'
            }}
            onMouseEnter={e => { e.currentTarget.style.backgroundColor = '#da291c'; e.currentTarget.style.transform = 'translateY(-2px)'; e.currentTarget.style.boxShadow = '0 12px 32px rgba(218,41,28,0.2)'; }}
            onMouseLeave={e => { e.currentTarget.style.backgroundColor = '#111'; e.currentTarget.style.transform = 'translateY(0)'; e.currentTarget.style.boxShadow = '0 8px 24px rgba(0,0,0,0.12)'; }}
          >
