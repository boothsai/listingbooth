...
export default async function ListingDetailPage({ params }: Props) {
  ...
  const jsonLd = {
    ...
    name: `${l.address_street || 'Property'} in ${l.address_city || 'Canada'}`,
    description: l.public_remarks?.slice(0, 300) || `${l.property_type || 'Property'} for sale in ${l.address_city || 'Canada'}.`,
    url: `https://listingbooth.com/listing/${l.listing_key}`,
    datePosted: l.updated_at,
    image: photos[0] || undefined,
    offers: {
      '@type': 'Offer',
      price: l.list_price,
      priceCurrency: 'CAD',
      availability: l.is_active ? 'https://schema.org/InStock' : 'https://schema.org/SoldOut',
    },
    address: {
      '@type': 'PostalAddress',
      streetAddress: l.address_street || '',
      addressLocality: l.address_city || '',
      addressRegion: l.address_province || 'ON',
      postalCode: l.address_postal_code || '',
      addressCountry: 'CA',
    },
    ...
    <main style={{ minHeight: '100vh', backgroundColor: '#fafafa' }}>
      ...
      <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '40px 40px 80px' }}>
        ...
        <div style={{ borderRadius: '20px', overflow: 'hidden', marginBottom: '40px', background: '#111', height: '480px', position: 'relative' }}>
          ...
          <SaveListingButton listingKey={l.listing_key} />
        </div>

        {/* ── Thumbnail strip → Lightbox ── */}
        <PhotoLightbox photos={photos} altText={l.address_street || 'Property'} />
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 360px', gap: '48px', alignItems: 'start' }}>
          ...
          <div style={{ position: 'sticky', top: '100px' }}>
            ...
            {/* Before You Offer Checklist — COMPETITIVE MOAT */}
