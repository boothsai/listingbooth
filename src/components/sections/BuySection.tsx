      ...
      <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '0 40px' }}>
              ...
              return (
                ...
                >
                  ...
                  <div style={{ height: '200px', background: '#f0f0f0', position: 'relative', overflow: 'hidden', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                    ...
                    <div style={{ position: 'absolute', top: '12px', right: '12px', backgroundColor: 'rgba(0,0,0,0.6)', color: 'white', fontSize: '11px', fontWeight: 600, padding: '4px 10px', borderRadius: '100px' }}>{dom === 0 ? 'Today' : `${dom}d ago`}</div>
                  </div>
                  {/* Info */}
                  <div style={{ padding: '16px 20px 0' }}>
                    ...
                    <div style={{ display: 'flex', gap: '16px', fontSize: '13px', color: '#555', fontWeight: 600, borderTop: '1px solid #f5f5f5', paddingTop: '10px', marginBottom: '0' }}>
        ...
        {!loading && !error && listings.length > 0 && (
          <div style={{ marginTop: '48px', textAlign: 'center' }}>
            <a href="#" onClick={e => { e.preventDefault(); fetchListings(searchInput, activeFilter); }} style={{ display: 'inline-flex', alignItems: 'center', gap: '8px', backgroundColor: '#da291c', color: 'white', padding: '16px 40px', borderRadius: '8px', fontSize: '16px', fontWeight: 800, textDecoration: 'none', boxShadow: '0 4px 14px rgba(218,41,28,0.35)' }}>
              View More Listings →
            </a>
          </div>
        )}
