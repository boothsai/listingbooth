        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '80px', alignItems: 'start' }}>
          ...
          <div>
            ...
            <p style={{ margin: '0 0 40px', fontSize: '17px', color: '#888', lineHeight: 1.7, maxWidth: '460px' }}>
              ListingBooth is built directly on the BOOTHS.AI Mothership — delivering real-time market intelligence and autonomous AI valuations instantly.
            </p>
            ...
            <div style={{ display: 'flex', gap: '16px' }}>
              <a href="/sell" style={{ display: 'inline-flex', alignItems: 'center', gap: '8px', backgroundColor: '#da291c', color: 'white', fontWeight: 800, fontSize: '15px', padding: '14px 32px', borderRadius: '8px', textDecoration: 'none', boxShadow: '0 4px 18px rgba(218,41,28,0.4)' }}>
                Get an AI Home Valuation →
              </a>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '16px' }}>
              {[
                ...
                { value: '$120M+', label: 'Transaction Volume', icon: '💰' },
            ...
            <div style={{ background: '#111', border: '1px solid #1e1e1e', borderRadius: '16px', padding: '28px' }}>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '12px' }}>
                {['CREA DDF', 'MLS®', 'Supabase', 'Stripe', 'Telnyx', 'FINTRAC'].map(brand => (
            ...
            <div style={{ background: 'linear-gradient(135deg, #da291c 0%, #8b1209 100%)', borderRadius: '16px', padding: '28px', textAlign: 'center' }}>
              ...
              <a href="/sell" style={{ background: 'white', color: '#da291c', fontWeight: 800, fontSize: '14px', padding: '10px 28px', borderRadius: '8px', textDecoration: 'none', display: 'inline-block' }}>
                Value My Hometed →
              </a>
            </div>
          </div>
