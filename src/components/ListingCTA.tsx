  ...
  return (
    <>
      <div style={{ background: 'white', border: '1.5px solid #eee', borderRadius: '20px', padding: '32px', boxShadow: '0 8px 32px rgba(0,0,0,0.06)', marginBottom: '16px' }}>
        ...
        <button
          onClick={openInfo}
          style={{ width: '100%', padding: '16px', background: 'white', color: '#111', border: '1.5px solid #e5e5e5', borderRadius: '10px', fontSize: '15px', fontWeight: 700, cursor: 'pointer', marginBottom: '24px' }}
        >
          💬 Request Info
        </button>
